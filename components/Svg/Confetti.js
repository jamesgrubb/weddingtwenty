...
const Confetti = (props, ref) => {
	return (
		<svg
			...
			<circle cx='45.612' cy='176.893' r='6.335' fill='#FD8002'></circle>
			<circle cx='138.635' cy='88.449' r='6.335' fill='#FD8002'></circle>
			<circle cx='132.3' cy='221.267' r='6.335' fill='#FD8002'></circle>
			<circle cx='320.307' cy='56.281' r='6.335' fill='#FD8002'></circle>
			<circle cx='144.97' cy='31.138' r='6.335' fill='#FD8002'></circle>
			<circle cx='228.262' cy='101.118' r='6.335' fill='#F02EC5'></circle>
			<circle cx='6.499' cy='113.277' r='6.335' fill='#F02EC5'></circle>
			<circle cx='199.692' cy='120.123' r='6.335' fill='red'></circle>
			...
			<circle
				...
				fill='#7409FB'
				fillOpacity='0.94'></circle>
			<circle cx='251.475' cy='88.449' r='6.335' fill='#0FB5FD'></circle>
